...
public class QueryWithResultSetExtractorDAO extends JdbcDaoSupport {
	...
	private static final String BASE_SQL = "Select d.Dept_Id, d.Dept_No, d.Dept_Name from Department d ";
	...
	public List<Department> queryDepartments() {
		...
		List<Department> list = this.getJdbcTemplate().query(sql, rse, 20);
		return list;
	}
